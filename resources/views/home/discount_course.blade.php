<div class="container mt-2">
  ...
  font-weight: bold;">Top Discounted Courses</h1>
      ...
      <div class="col-md-6 mb-3">
          <div class="row p-2 bg-white border rounded">
              ...
              <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                  ...
                  <div class="d-flex flex-column mt-4"><a href="" class="btn btn-outline-primary btn-sm mt-2">Details</a>
                    {{-- <button class="btn btn-outline-primary btn-sm mt-2" type="button" href="{{url('add_cart',$course->id)}}">Add to Cart</button> --}}
                    <a href="{{url('add_cart',$course->id)}}" class="btn btn-outline-primary btn-sm mt-2">Add to Cart</a></div>
              </div>
          </div>
